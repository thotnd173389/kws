...
from utils import keyword_marvin_v3_vl_0_4
...
# %%
model = keyword_marvin_v3_vl_0_4(input_shape=(16000), data_settings=data_settings)
...
if not os.path.exists(training_settings.summaries_dir):
    os.mkdir(training_settings.summaries_dir)
if not os.path.exists(os.path.join(training_settings.summaries_dir, model.name)):
    os.mkdir(os.path.join(training_settings.summaries_dir, model.name))
