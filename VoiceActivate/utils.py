...
def E2E_1stage_v8(input_shape=(16000,), data_settings = None, dropout = 0.5):
...
def keyword_marvin_v3(input_shape=(16000,), data_settings = None, dropout = 0.2):
    ...
    # Create model
    model = tf.keras.models.Model(inputs=X_input, outputs=X, name='keyword_marvin_v3')

    return model


def keyword_marvin_v3_vl_0_3(input_shape=(16000,), data_settings = None, dropout = 0.2):
    ...
    # Create model
    model = tf.keras.models.Model(inputs=X_input, outputs=X, name='keyword_marvin_v3_vl_0_3')
